...
function App() {
  ...
  const addSegment = (p: Point) => {
    ...
    updateActive((s) => {
      ...
      if (last.type === 'Z') {
        return { ...s, segments: [...s.segments, makeLineSegment(segmentEnd(last, s.segments), p)] };
      }
  ...
  const updateLastSegment = (seg: Segment) => {
    if (!activeId) return;
    updateActive((s) => {
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 relative bg-slate-950 overflow-hidden">
          <PathCanvas
            ...
            onUpdateLastSegment={updateLastSegment}
                      ...
                      <div className="space-y-4">
                        ...
                        {lastSeg && lastSeg.type !== 'M' && (
                          <div className="text-[11px] text-slate-500 flex items-center gap-1.5 pt-1">
                            ...
                            Pink points are draggable. Drag the last endpoint to
                            reposition it.
                          </div>
                        )}
                      </div>
